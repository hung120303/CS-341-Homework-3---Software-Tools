...
var host = "34.83.46.149";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = ",t2>lQTE9hH#@lts";  //password (change to match your db, yes this is very poor practice)
